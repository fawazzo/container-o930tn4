...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o930tn4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o930tn4.containers.anotherwebservice.com/
...
```
git clone git@github.com:fawazzo/container-o930tn4.git
cd container-o930tn4
```
...
```
docker attach container-o930tn4
```
